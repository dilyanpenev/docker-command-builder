...
```shell
  docker buildx build -t dido28/docker-command-builder:latest . --load
```

To install the extension, use `make install-extension` **or**:

```shell
  docker extension install dido28/docker-command-builder:latest
```
...
```shell
  docker extension dev ui-source dido28/docker-command-builder:latest http://localhost:3000
```

In order to open the Chrome Dev Tools for your extension when you click on the extension tab, run:

```shell
  docker extension dev debug dido28/docker-command-builder:latest
```

Each subsequent click on the extension tab will also open Chrome Dev Tools. To stop this behaviour, run:

```shell
  docker extension dev reset dido28/docker-command-builder:latest
```
...
```shell
docker extension update dido28/docker-command-builder:latest
```
...
```shell
docker extension rm dido28/docker-command-builder:latest
```
